...
class AmbientTemperature extends StatefulWidget {
  @override
  _AmbientTemperatureState createState() => _AmbientTemperatureState();
}

class _AmbientTemperatureState extends State<AmbientTemperature> with SingleTickerProviderStateMixin {
  // Animation controller for the icon animation
  late AnimationController _animationController;
  late Animation<double> _animation;
  // Stream to fetch temperature data
  ...
  void initState() {
    ...
    // Initial update of the heart rate stream
    _updateHeartRateStream(_currentView);
  }

  // Function to update the heart rate stream based on the selected view
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                  ...
                  builder: (context, snapshot) {
                    ...
                    try{
                      ...
                      style: const TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 60,
                        color: Color.fromARGB(255, 206, 121, 9),
                      ),
                    );
                    } catch(e){
                      return const Text(
            ...
            // Line chart to display temperature data
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: _heartRateStream,
              builder: (context, snapshot) {
                if (snapshot.hasError) {
