...
// Enum to manage the view state (daily, weekly, monthly)
enum ViewState {
  daily,
  weekly,
  monthly,
...
class _AirPressureState extends State<AirPressure>
  ...
  // Function to update the heart rate data stream based on the selected view
              ...
              children: [
                ...
                StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    try {
                      final latestReading =
                          snapshot.data!.docs.first['reading'].toString();
                      return Text(
                        latestReading,
            ...
            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                try {
                  ...
                  final double minHeartRate = heartRateData.reduce(
                      (a, b) => a < b ? a : b);
                  final double maxHeartRate = heartRateData.reduce(
                      (a, b) => a > b ? a : b);
                  return Column(
                    children: [
            ...
            Row(
              ...
              children: [
                ...
                OutlinedButton(
                  ...
                  child: const Text(
                    'Daily',
                    style: TextStyle(color: Color.fromARGB(255, 13, 177, 173)),
                  ),
                ),
                const SizedBox(width: 10),
                OutlinedButton(
    ...
    return LineChart(
      LineChartData(
        ...
        borderData: FlBorderData(
          show: true,
          border: Border.all(
              color: const Color.fromARGB(255, 160, 212, 255), width: 1),
        ),
  ...
  // Widget to build the metric card (AVG, MIN, MAX)
